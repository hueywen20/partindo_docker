...
<if criteria="$useraccess[add_deassembly]">
...
<script type="text/javascript">
	...
	function ajaxsearch(keywords,fields,page){
		$.get("deassembly.php", {getlist: "xml", \'list\': "general", \'keyword[]\': keywords, \'field[]\': fields, status: "1", p: page, hdv: heightdiv, cwidth: realcolwidth}, function(data){
	...
	function ajaxfromcookie(page){
		...
		var fieldstext = getCookie("fielddeassembly");
		
		if (fieldstext != ""){
			var keywordstext = getCookie("keyworddeassembly");
	...
	function searchnow(){
		...
		setCookie("keyworddeassembly",keywords);
		setCookie("fielddeassembly",fields);

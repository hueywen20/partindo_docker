...
window.onload = function() {
    cal = new dhtmlxCalendarObject("date",true,{
		isWinHeader: true,
        isWinDrag: true,
		isYearEditable: true,
...
<form name="reportstock" action="reportstock.php?view=period" method="post" target="_blank">
<table border="0" cellpadding="5" cellspacing="5">
<tr>
	<td align="left">Kode Barang</td>
	<td align="left" width="200">
	<div id="stockel" style="width:100%; height:25px;"></div>
	<script type="text/javascript">
		var z = new dhtmlXCombo("stockel", "stockcode", "100%");
		z.enableFilteringMode(true, "ajax.php?list=firststock&type=xml", false);
		z.loadXML("ajax.php?list=firststock&type=xml");
	</script></td>
</tr>
<tr>
	<td align="left">Tanggal</td>
	<td align="left">
	<input type="text" name="date" id="date" size="20" readonly></td>
</tr>
</table>
<div align="left">&nbsp;&nbsp;&nbsp;

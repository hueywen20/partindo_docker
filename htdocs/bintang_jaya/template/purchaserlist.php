...
Pencarian : <select id="searchfield">
	...
	<option value="buyrdate">Tanggal Retur Pembelian</option>
	<option value="suppliername">Nama Supplier</option>
	<option value="orderno">No Bon</option>
...
<script>
	...
	function ajaxsearch(keywords,fields,page){
		$.get("purchaser.php", {getlist: "xml", list: "general", keyword: keywords, p: page, hdv: heightdiv, field: fields, cwidth: realcolwidth}, function(data){
	...
	function ajaxfromcookie(page){
		...
		var fields = getCookie("fieldbuyr");
		
		var keywords = getCookie("keywordbuyr");
	...
	function searchnow(){
		...
		setCookie("keywordbuyr",keywords);
		setCookie("fieldbuyr",fields);
	...
	var heightdiv = document.documentElement.clientHeight-70;
</script>

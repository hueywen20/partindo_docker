...
<title>$company[companyname] - Laporan Penjualan per Tanggal Jatuh Tempo</title>
<link media="all" href="css/print_small.css" type="text/css" rel="stylesheet">
</head>

<body leftmargin="0" topmargin="0" rightmargin="0" marginheight="0" marginwidth="0">
<if criteria="!empty($list)">
<div align="center" class="reporttitle" style="width: 100%">LAPORAN PENJUALAN JATUH TEMPO<br>

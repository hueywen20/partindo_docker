...
<form action="payment.php" method="post" onsubmit="return confirm(\'OK?\')">
<b>Jalankan auto rekap penagihan penjualan sekarang : </b>
...
<div align="left" style="padding: 3px">Periode&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
...
<img src="img/loading.gif" border="0" width="16" height="16"></span>
<span style="float: right">
Gunakan Kode Faktur Penjualan : 
<select id="usecode">
...
Pilih Jenis Kertas : 
<select id="papers">
	<option value="f4">F4 / HVS</option>
	<option value="a4">A4</option>
	<option value="letter">Letter</option>
</select>
<input type="button" value="Cetak Tanda Terima" class="button" onclick="window.open(\'printpayment.php?startpaysdate=\'+$(\'#startpaysdate\').val()+\'&endpaysdate=\'+$(\'#endpaysdate\').val()+\'&paper=\'+$(\'#papers :selected\').val()+\'&usecode=\'+$(\'#usecode :selected\').val(),\'_blank\')"></span></div>
<script>
	var headertext = [
		"No Penagihan",
		"Tanggal Penagihan",
	...
	function ajaxsearch(getsearchfield,getstartpaysdate,getendpaysdate){
		...
		$.get("payment.php", {getlist: "xml", list: "general", keyword: keyw, field: getsearchfield, startpaysdate: getstartpaysdate, endpaysdate: getendpaysdate, cwidth: realcolwidth}, function(data){
	...
	function ajaxfromcookie(){
		...
		var getsearchfield = getCookie("searchfieldpay");
		var getstartpaysdate = getCookie("startpaydate");
		var getendpaysdate = getCookie("endpaydate");
		$("#keyword").val(getCookie("searchfieldkeyw"));
	...
	function goajax(obj){
		...
		setCookie("searchfieldkeyw",obj.value);
		setCookie("searchfieldpay",getsearchfield);
		setCookie("startpaydate",getstartpaysdate);
		setCookie("endpaydate",getendpaysdate);
	...
	var heightdiv = document.documentElement.clientHeight-120;
</script>

	...
	if (cell){
      ...
      this.grid = this.cell.parentNode.grid;
                    if (!this.grid._grid_calendarA) {
                    		...
                    		var sgrid=this.grid;
                    		this.grid._grid_calendarA.setOnClickHandler(function(){
...
eXcell_dhxCalendar.prototype = new eXcell;
	...
	eXcell_dhxCalendar.prototype.setValue = function(val){
						...
						if(!val || val.toString()._dhx_trim()==""){
							...
							this.cell.val=new Date(this.grid._grid_calendarA.setFormatedDate((this.grid._dtmask||"%d/%m/%Y"),val.toString()));
						}
